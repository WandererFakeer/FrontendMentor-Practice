...
According to MDN, image is called as *replaced element* ([<img>: The Image Embed element
](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/img)), I was bit confused as to in which element should I nest the images.
